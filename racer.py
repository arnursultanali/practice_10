...
# Загрузка и подготовка фона (Твоя обрезанная дорога)
bg_img = pygame.image.load("road.jpg")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        ...
        # Масштабируем врага, чтобы он не был гигантским
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        ...
        # Эта строка уберет белый фон вокруг монетки:
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.transform.scale(img, (50, 90))  # Масштабируем игрока
        self.rect = self.image.get_rect()
